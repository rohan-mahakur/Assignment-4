...
def check_lib(lib, unique_words, word_to_books, sort_output=True):
    ...
    # print(lib.count_distinct_words("book1"),len(unique_words[0]) , lib.count_distinct_words("book2"), len(unique_words[1]))
    if lib.count_distinct_words("book1") == len(unique_words[0]) and lib.count_distinct_words("book2") == len(
            unique_words[1]):
